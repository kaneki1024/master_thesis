...
\tableofcontents
  \chapter{序論}
	...
	\chapter{結果と考察}
			...
			弾性率を計算した。温度と弾性率の関係が図\ref{温度_弾性率_セリシンなし}である。
			共鳴周波数から求める際にパラメータが寸法$l$と密度$\rho$しかないため
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=\linewidth]{温度_誘電率_セリシンなし_拡大.jpg}
				\caption{-70℃から120℃における共鳴周波数。(A)は周波数分散における共鳴周波数の変動の様子(黒点線)。
				(B)は共鳴周波数と温度の関係。}
