  ...
  \chapter{序論}
	...
	\chapter{原理}
		...
		これらを式にまとめると
			...
			また、$1-k^2$が応力$T$を0とした誘電率$\varepsilon^T$と歪み$S$を0としたときの
			誘電率$\varepsilon^S$の比となる。
			...
			\end{equation}
			インピーダンスアナライザなどを用いて容量を計測し、周波数を変動させながら
			...
			\begin{figure}[h]
				...
				\caption{Fibroin cast film における圧電性\cite{fibroin_cast_film_piezo}$^{\mbox{\scriptsize{引用し一部改良}}}$。
			...
			\begin{figure}[h]
				...
				\caption{配向性、逆平行$\beta$ sheetの含有量と圧電性の関係\cite{fibroin_cast_film_piezo}$^{\mbox{\scriptsize{引用し一部改良}}}$}
