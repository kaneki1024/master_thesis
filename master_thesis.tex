  ...
  \chapter{序論}
	...
	\chapter{実験手法}
		...
		\section{評価方法}
			...
			抵抗$R_s$とコンデンサ$C_s$の値を求めて、式\ref{real_epsilon}と式\ref{imaginary_epsilon}から
			誘電率の実部虚部を計算出来る。圧電性の評価においては誘電率を測定し、誘電率に現れる圧電共鳴成分を用いて評価
			する圧電共鳴法を用いた。
			\subsubsection{圧電共鳴法}
			...
			\begin{equation}
				...
				\label{ずりの電気機械結合係数}
			\end{equation}
			下のように試料を正方形ではなく、長方形にカットして圧電共鳴スペクトルを観測した事例もある\cite{PLA_長方形_圧電共鳴}。
			\begin{figure}[h]
				\centering
				\begin{minipage}{0.45\hsize}
					\centering
