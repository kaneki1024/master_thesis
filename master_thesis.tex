  ...
  \chapter{序論}
	...
	\chapter{結果と考察}
			...
			\begin{figure}[H]
				...
				\caption{セリシンを除去したシルクフィルムで-70℃から120℃における共鳴周波数と弾性率。(A)は周波数分散における共鳴周波数の変動の様子(黒点線)。
				(B)は共鳴周波数と温度の関係、(C)は弾性率と温度の関係。}
		...
		微小な減少傾向である。
			...
			\begin{figure}[h]
				...
				\caption{セリシンを除去していないシルクフィルムで-70℃から120℃における共鳴周波数と弾性率。(A)は周波数分散における共鳴周波数の変動の様子(黒点線)。
				(B)は共鳴周波数と温度の関係、(C)は弾性率と温度の関係。}
				\label{温度_弾性率_セリシンあり}
			\end{figure}
			\begin{figure}[h]
				\centering
				\includegraphics[width=\linewidth]{温度_k_e_d_セリシンあり.jpg}
				\caption{}
			\end{figure}
	...
	\begin{figure}[h]
		...
		\caption{キャストで作成した試料。(A)はセリシンを除去しなった試料、(B)はセリシンを除去した試料。}
	\end{figure}
	\newpage
	\section{DSC}
	\label{DSC}
