...
\tableofcontents
  \chapter{序論}
		\section{研究背景}
		2015年9月25-27日、国連総会において「国連持続可能な開発サミット」
		が開催された。その成果文書として 
		"Transforming Our World: 2030 Agenda for Sustainable Development" を採択した\cite{sdgs_2030}。
		内容は17の目標と169のターゲットから構成されており、まとめて
		「持続可能な開発目標（SDGs）」と呼ばれる。
		

		\begin{figure}[b]
			\centering
			\includepdf[width=\linewidth]{sdg_poster.pdf}
